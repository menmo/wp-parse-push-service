...
if (isset($_POST['pps_delete_hidden']) && ($_POST['pps_delete_hidden'] == 'Y')) {
    ...
    if (isset($_POST['pps_scheduled_posts'])) {
        ...
        ?>
        <div class="updated"><p><strong><?php _e('Future push notifications removed.'); ?></strong></p></div>
        <?php
    }
            ...
            <div id="post-body-content">
                ...
                <div class="scheduled-posts-queue">
                    ...
                    if (!$query->have_posts()) {
                        ...
                        <form name="pps_form" method="post"
                            ...
                            <table class="widefat">
                                ...
                                while ($query->have_posts()) {
                                    ...
                                    echo '  <td>';
                                    echo '  <input type="checkbox" class="pps_ckb" name="pps_scheduled_posts[]" value="' . get_the_ID() . '" />';
                                    echo '  </td>';
                                    echo '  <td><a href="' . get_edit_post_link(get_the_ID()) . '">' . get_the_title() . '</a></td>';
                                    echo '  <td>' . get_post_meta(get_the_ID(), '_pps_future_notification_message', true) . '</td>';
                            ...
                            <p class="submit">
                                <a id="pps_delete_ask" href="#" class="button button-secondary ">Remove
                                    notifications</a>

                            <p id='pps_delete_confirm' style="display: none;">
                                Are you sure? &nbsp;
                                <input id="pps_delete_confirm" type="submit" name="Submit" class="button button-primary"
                                       value="<?php _e('Yes, remove them from queue', 'pps_trdom') ?>"/>
                                <a id="pps_delete_deny" href="#" class="button button-secondary">No, cancel this
                                    action</a>
                            </p>
                            </tr>
                        </form>
